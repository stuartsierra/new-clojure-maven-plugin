...
public class ClojureReflector {
    ...
    private final Object loadStringVar;
    private final Object loadReaderVar;
    ...
    public ClojureReflector() throws Exception {
        ...
        loadReaderVar = var("clojure.core", "load-reader");
    }
    ...
    public Object loadReader(Reader reader) throws Exception {
        return invoke(loadReaderVar, reader);
    }
}
